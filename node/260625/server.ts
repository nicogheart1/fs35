...
import { authorize, chiSono, login, registrazione } from "./controllers/auth";
...
app.get("/chi-sono", authorize, chiSono);

app.get("/students", authorize, getAllStudents);
